...
Compile this software yourself so you can be aware how it works. See compiling options below.
If you don't have tools, download prebuilt releases from GitHub: [secled Releases](https://github.com/triiberg/secled/releases)
